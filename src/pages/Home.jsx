                ...
                <div className="relative z-10">
                  ...
                  >
                    <service.icon className={`w-12 h-12 ${
                      service.title === 'Web Development' ? 'text-blue-600' :
                      service.title === 'Mobile Development' ? 'text-green-600' :
                      service.title === 'UI/UX Design' ? 'text-purple-600' :
                      service.title === 'Cloud Solutions' ? 'text-cyan-600' :
                      service.title === 'Performance' ? 'text-indigo-600' :
                      'text-teal-600'
                    }`} />
                  </motion.div>
