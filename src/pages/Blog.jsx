    ...
    <>
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            {categories.map((category, index) => (
              ...
              >
                {category}
                {selectedCategory === category && (
                  <div className="absolute -inset-1 bg-[#4e45e1] rounded-full blur opacity-30 group-hover:opacity-50 transition-opacity duration-300"></div>
                )}
              </button>
            ))}
          </div>
                ...
                <div className="md:w-1/2 p-8">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      <div className="w-10 h-10 bg-[#4e45e1] rounded-full flex items-center justify-center text-white text-sm font-bold group-hover:scale-110 transition-transform duration-300">
                    ...
                    <Link
                      ...
                      className="group/link bg-[#4e45e1] hover:bg-[#4139BF] text-white px-6 py-2 rounded-lg font-medium transition-all duration-300 transform hover:scale-105"
                    >
                      Read More
                    </Link>
                  </div>
      ...
      <section className={`${responsiveSpacing.sectionPadding} relative`}>
              ...
              {gridPosts.map((post) => (
                <article key={post.id} className="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-4 border border-gray-100">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                        <div className="w-8 h-8 bg-[#4e45e1] rounded-full flex items-center justify-center text-white text-sm font-bold group-hover:scale-110 transition-transform duration-300">
        ...
        <ModernCTA 
          ...
          subtitle="Get the latest articles, tutorials, and industry updates delivered straight to your inbox."
          primaryText="Subscribe Now"
          primaryLink="/contact"
          secondaryText="View All Posts"
          secondaryLink="/blog"
        />
      </PageLayout>
    </>
