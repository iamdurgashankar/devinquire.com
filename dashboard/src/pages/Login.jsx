...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response) {
        navigate('/'); // Redirect all users to dashboard home after login
      }
    } catch (error) {
        ...
        <div className="flex-1 flex items-center justify-center px-8 lg:px-16 relative">
          ...
          <div className="max-w-md w-full space-y-8 relative z-10">
            ...
            <div className="space-y-4">
              <Link
                to="/login"
                className="block w-full py-4 px-6 text-center bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-medium rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-xl"
              >
                Sign In
              </Link>
              ...
              <Link
                to="/register"
                className="block w-full py-4 px-6 text-center border-2 border-blue-500 hover:bg-blue-500/20 text-blue-400 hover:text-white font-medium rounded-2xl transition-all duration-300 transform hover:scale-105"
              >
                Create Account
              </Link>
              ...
              <Link
                to="/admin"
                className="block w-full py-4 px-6 text-center border-2 border-purple-500 hover:bg-purple-500/20 text-purple-400 hover:text-white font-medium rounded-2xl transition-all duration-300 transform hover:scale-105"
              >
                Admin Access
              </Link>
            </div>
