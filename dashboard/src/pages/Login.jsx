...
export default function Login() {
  ...
  return (
    <AuthLayout
      ...
      subtitle="Gaze and attention modeling powered by AI is optimizing virtual reality experiences"
    >
      <div className="space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            <div className="relative group">
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full pl-14 pr-12 py-4 bg-white border border-neutral-200 rounded-full focus:outline-none focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500 transition-all text-neutral-900 placeholder-neutral-400 font-medium shadow-sm"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4 px-6 bg-[#0EA5E9] hover:bg-[#0284C7] text-white font-semibold rounded-full shadow-lg shadow-sky-500/30 transform hover:-translate-y-0.5 transition-all duration-200 disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-2 text-lg"
          >
            {loading ? (
              <>
        ...
        <p className="text-center text-neutral-500 mt-6 font-medium">
        ...
        <AnimatePresence>
          {error && (
            <motion.div
              ...
              className="p-4 bg-red-50 text-red-600 rounded-2xl flex gap-3 text-sm border border-red-100 mt-4"
            >
